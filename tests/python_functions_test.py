...
#   @unittest.skip("delete this line to run the test")
  def test_volume_of_cube(self):
      cube_volume = volume_of_cube(10, 5, 10)
      self.assertEqual(500, cube_volume )

  # Given a String, return the String reversed
  # @unittest.skip("delete this line to run the test")
  def test_reverse_string(self):
    reversed_text = reverse_string("Hello E56")
    self.assertEqual("65E olleH", reversed_text)
